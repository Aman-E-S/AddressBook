...
namespace demo_.Controllers
{
...

    {
        ...
        public async Task<IActionResult> Add(AddStudentViewModel viewModel)
        {
            ...
            await dbConetxt.StdLists.AddAsync(student);
        ...
        public async Task<IActionResult> List(String sort, String Search) 
        {
            ...
            var student = await dbConetxt.StdLists.ToListAsync();
        ...
        {   
            var Student = await dbConetxt.StdLists.FindAsync(id);
            return View(Student); 
        }
        [HttpPost]
        public async Task<IActionResult> Edit(Student viewModel)
        {
            ...
            var student = await dbConetxt.StdLists.FindAsync(viewModel.id);
        ...
        {
            var student = await dbConetxt.StdLists.AsNoTracking().FirstOrDefaultAsync(x => x.id == viewMoedl.id);
            if (student is not null)
            {
                dbConetxt.StdLists.Remove(viewMoedl);
                await dbConetxt.SaveChangesAsync();
            }
